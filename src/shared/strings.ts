...
export const strings = {
    ...
    clientBuilder: {
        ...
        translationsPageDescription: 'List of all translations defined by key and translations stored into the localization context. To create a new one use the form placed right below this text.',
        staticContentPageTitle: 'Static content items list',
        staticContentPageDescription: 'List of all static content items defined by key and translation content stored into the localization context. To create a new one use the form placed right below this text.',
